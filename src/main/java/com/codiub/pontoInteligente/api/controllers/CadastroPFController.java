package com.codiub.pontoInteligente.api.controllers;
...
import com.codiub.pontoInteligente.api.dtos.CadastroPFDto;
import com.codiub.pontoInteligente.api.entities.Empresa;
import com.codiub.pontoInteligente.api.entities.Funcionario;
import com.codiub.pontoInteligente.api.enums.PerfilEnum;
import com.codiub.pontoInteligente.api.response.Response;
import com.codiub.pontoInteligente.api.services.EmpresaService;
...
public class CadastroPFController {
	...
	private CadastroPFDto converterCadastroPFDto(Funcionario funcionario) {
		...
		funcionario.getQtdHorasTrabalhoDiaOpt().ifPresent(
				qtdHorasTrabDia -> cadastroPFDto.setQtdHorasTrabalhaDia(Optional.of(Float.toString(qtdHorasTrabDia))));
