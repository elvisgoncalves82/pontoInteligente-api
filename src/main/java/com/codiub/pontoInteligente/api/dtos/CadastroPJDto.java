package com.codiub.pontoInteligente.api.dtos;
...
public class CadastroPJDto {
	...
	@Length(min = 5 , max = 200, message="Razao social deve conter entre 3 e 200 caracteres")
	...
	@CNPJ(message="valor CNPJ invalido")
